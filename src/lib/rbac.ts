...
export const PERMISSIONS = {
  ...
  "leave.approve": "تأیید مرخصی (مرحله اول – سرپرست/مدیر)",
  "leave.approve.l2": "تأیید مرخصی (مرحله دوم – معاونت/کمیته منابع انسانی)",
  "leave.approve.l3": "تأیید مرخصی (مرحله سوم – مدیرعامل)",
